...
# # testnum = int(input), int(input("숫자 입력 :"))
# # if testnum % 2 == 0:
# #     print("짝수")
# # else:
# #     print("홀수")
...
# # now = datetime.datatype.now()
# # print(now)
# # print("{}년 {}월 {}일 {}분 {}초").format(now.year, now.month, now.day, now.hourn, now.minute, now.second)
...
# # > 80 A 학점, > 60 B학점, > 40 C학점, > 20 D학점, E학점
